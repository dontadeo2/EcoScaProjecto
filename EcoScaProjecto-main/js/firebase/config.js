...
//  ¡MODIFICACIÓN AQUÍ!: Activamos el almacenamiento para las fotos de EcoScan
// const storage = firebase.storage(); -> Lo comentamos porque usaremos ImgBB

console.log('✅ Firebase inicializado correctamente (Database y Storage)');
